...
$data = [
    'China' => [
        ...
        'hotels' => [
            ...
            ['name' => 'Guangzhou Garden Inn', 'rating' => 3, 'price' => 90, 'room_type' => 'single', 'attractions' => ['Canton Tower', 'Baiyun Mountain']],
            ['name' => 'Chengdu Comfort', 'rating' => 4, 'price' => 110, 'room_type' => 'twin', 'attractions' => ['Giant Panda Base', 'Wuhou Shrine']],
            ['name' => 'Xi An Heritage Hotel', 'rating' => 4, 'price' => 100, 'room_type' => 'double', 'attractions' => ['Terracotta Army', 'Ancient City Wall']]
        ]
    ],
    'Malaysia' => [
        'flights' => [
